window.PROJECT_DATA = {
    ...
    meta: [
        { icon: "bx-joystick",    text: "Playable demo" },
    ...
    cta: [
        ...
        { label: "Project details",  icon: "bx-info-circle", href: "../pages/sandsofdawn.html", primary: false, external: false },
    ],
    slides: [
        { src: "../images/sands-of-dawn/2.jpg",    alt: "Gameplay"    },
        { src: "../images/sands-of-dawn/3.png",    alt: "Combat"      },
        { src: "../images/sands-of-dawn/4.png",    alt: "Environment" },
        { src: "../images/sands-of-dawn/Logo.jpg", alt: "Logo"        },
    ],
    detail: {
